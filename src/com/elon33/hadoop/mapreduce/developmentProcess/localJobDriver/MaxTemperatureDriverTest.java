package com.elon33.hadoop.mapreduce.developmentProcess.localJobDriver;
...
//vv MaxTemperatureDriverTestV2
  ...
  public void test() throws Exception {
    ...
    Path input = new Path("input/localJobDriver");
    Path output = new Path("output/localJobDriver");
