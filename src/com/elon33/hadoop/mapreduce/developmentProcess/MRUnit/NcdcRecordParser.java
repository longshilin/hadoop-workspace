...
package com.elon33.hadoop.mapreduce.developmentProcess.MRUnit;
...
public class NcdcRecordParser {
  ...
  public boolean isValidTemperature() {
    return airTemperature != MISSING_TEMPERATURE && quality.matches("[01459]");		//quality字符代表的是[0,1,4,5,9]其中的某一个
  }
